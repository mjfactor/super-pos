 ...
 * @author Win10
 */
public class retrieval_catogory extends javax.swing.JFrame {

    /**
     * Creates new form category
     */
    public retrieval_catogory() {
        initComponents();
        table_update();
    ...
    private void initComponents() {
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/superpos/DicePics/Logo1.png"))); // NOI18N
    ...
    public void categoryBinDelete() {
        ...
        int id = Integer.parseInt(d1.getValueAt(selectIndex, 0).toString());
            ...
            try {
                ...
                pst = con1.prepareStatement("delete from category_bin where id = ?");
                pst.setInt(1, id);
                pst.executeUpdate();
                table_update();
    ...
    private void table_update() {
        try {
            ...
            try {
                ...
                pst = con1.prepareStatement("select * from category_bin");
...
//                      }
                ...
                Logger.getLogger(retrieval_catogory.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jLabel11.setText(d1.getValueAt(selectIndex, 2).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String status = jLabel11.getText();
        ...
        try {
            ...
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Category Retrieved");
            table_update();
            jLabel10.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null, "Do you want to Permanently Delete the Category? ", "Warning", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(retrieval_catogory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new retrieval_catogory().setVisible(true);
            }
        });
    }
