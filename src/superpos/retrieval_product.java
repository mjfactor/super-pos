 ...
 * @author Win10
 */
public class retrieval_product extends javax.swing.JFrame {

    /**
     * Creates new form category
     */
    public retrieval_product() {
        initComponents();
        table_update();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 1544, Short.MAX_VALUE)
        );
    ...
    public void productBinDelete() {
        ...
        try {
            ...
            pst = con1.prepareStatement("delete from product_bin where id = ?");
            pst.setInt(1, id);
            pst.executeUpdate();
            table_update();
    ...
    private void table_update() {
        try {
            ...
            try {
                ...
                pst = con1.prepareStatement("select * from product_bin");
...
//                      }
                ...
                Logger.getLogger(retrieval_product.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jLabel13.setText(d1.getValueAt(selectIndex, 1).toString());
        jLabel14.setText(d1.getValueAt(selectIndex, 2).toString());

        jLabel22.setText(d1.getValueAt(selectIndex, 3).toString());
        jLabel23.setText(d1.getValueAt(selectIndex, 4).toString());
        jLabel24.setText(d1.getValueAt(selectIndex, 5).toString());
        jLabel25.setText(d1.getValueAt(selectIndex, 6).toString());
        jLabel26.setText(d1.getValueAt(selectIndex, 7).toString());
        jLabel27.setText(d1.getValueAt(selectIndex, 8).toString());
        jLabel28.setText(d1.getValueAt(selectIndex, 9).toString());
    ...
    private void jRadioButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton3ActionPerformed
        retrieval_user rc = new retrieval_user();
        dispose();
        rc.setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String description = jLabel14.getText();
        String category = jLabel22.getText();
        String brand = jLabel23.getText();
        int costp = Integer.parseInt(jLabel24.getText());
        int retailp = Integer.parseInt(jLabel25.getText());
        int qty = Integer.parseInt(jLabel26.getText());
        int barcode = Integer.parseInt(jLabel27.getText());
        ...
        try {
            ...
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Product Retrieved");
            table_update();
            jLabel10.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null, "Do you want to Permanently Delete the Product? ", "Warning", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(retrieval_product.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new retrieval_product().setVisible(true);
            }
        });
    }
