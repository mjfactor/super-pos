 ...
 * @author Win10
 */
public class retrieval_brand extends javax.swing.JFrame {

    /**
     * Creates new form category
     */
    public retrieval_brand() {
        initComponents();
        table_update();
    ...
    private void initComponents() {
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/superpos/DicePics/Logo1.png"))); // NOI18N
    ...
    public void brandBinDelete() {
        ...
        try {
            ...
            pst = con1.prepareStatement("delete from brand_bin where id = ?");
            pst.setInt(1, id);
            pst.executeUpdate();
            table_update();
    ...
    private void table_update() {
        try {
            ...
            try {
                ...
                pst = con1.prepareStatement("select * from brand_bin");
...
//                      }
                ...
                Logger.getLogger(retrieval_brand.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            try {
                ...
                pst.executeUpdate();
                JOptionPane.showMessageDialog(null, "Brand Retrieved");
                table_update();
                jLabel10.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null, "Do you want to Permanently Delete the Brand? ", "Warning", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(retrieval_brand.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new retrieval_brand().setVisible(true);
            }
        });
    }
