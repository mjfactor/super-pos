...
public class category extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Category", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Century Gothic", 1, 36), new java.awt.Color(24, 52, 52))); // NOI18N
        ...
        txtcat.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtcat.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(24, 52, 52), 3));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/superpos/DicePics/stacked-files.png"))); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtstatus, javax.swing.GroupLayout.PREFERRED_SIZE, 310, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(16, 16, 16)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtcat, javax.swing.GroupLayout.PREFERRED_SIZE, 310, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addComponent(jPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, 935, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    public void categoryLogs2() {
        ...
        try {
            ...
            pst = con1.prepareStatement("insert into category_logs (category, date, time, status) values(?,?,?,?)");
    ...
    public void categoryBin() {
        ...
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/superpos", "root", "your_password");
            pst = con1.prepareStatement("insert into category_bin(category, status) values(?,?)");
            //it gets the data in the boxes and puts it in the table (column, box data) 
            pst.setString(1, category);
...
//                      }
        ...
        try {
            ...
            if (txtcat.getText().trim().isEmpty()) {
                ...
                try {
                    ...
                    //Enter the data in the table
                    pst.executeUpdate();
                    JOptionPane.showMessageDialog(null, "Cateogry Added");
                    table_update();
                   ...
                   JOptionPane.showMessageDialog(null, "This Category "+"'"+category+"'"+" is already in Database!");
                   txtcat.setText("");
                    //this resets the combo box
                    txtstatus.setSelectedIndex(-1);
                    Logger.getLogger(category.class.getName()).log(Level.SEVERE, null, ex);
        ...
        try {
            ...
            if(txtcat.getText().trim().isEmpty()){
              ...
              try {
                ...
                //Enter the data in the table
                pst.executeUpdate();
                JOptionPane.showMessageDialog(null, "Cateogry Updated");
                table_update();
        ...
        try {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                try {
                    ...
                    pst.setInt(1, id);
                    JOptionPane.showMessageDialog(null, "Cateogry Deleted");
                    pst.executeUpdate();
                    table_update();
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        JOptionPane.showMessageDialog(this, "You're already in CATEGORY window!");
